...
function getEmon() {
    ...
    //
    //
    var dataRequest = request( emonDataRequestOptions, function (error, response, body) {
        if(!error) {
            //
            ...
            if( response.statusCode == 200 ) {
                ...
                var tokenRequest = request(emonTokenRequestOptions, function(error, response, body){
                    if(!error) {
                        if (response.statusCode == 200) {
